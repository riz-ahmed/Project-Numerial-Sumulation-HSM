function [R,P,Q,I,I_err,M0,re0stern] = RKV45_RPQI_fase(ps,p0,T0,Rgas,kappa,my0,h0,h1,r0,r1,ra,eps)    

% Funktion der Spalthöhe, abhängig von R

    h_r = @(h0,h1,r1,R,r0) h0+((h0-h1)/(r0-r1))*(R*r0); 
...
% Ergebnismatrix wird geschrieben
    nullmatrix = zeros(intervalle+1,4);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%            
        % Schrittweitensteuerung
            ...
            % Schrittweite mal Epsilon( obere Schrnake für
