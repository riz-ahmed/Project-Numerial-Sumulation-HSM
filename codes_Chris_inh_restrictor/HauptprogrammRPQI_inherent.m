% Hauptprogramm - Berechnung P(R),Q(R),I(R) - Inherent Restrictor
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Dieses Programm berechnet den Düsentyp "Inherent Restrictor"
...
tic
% h eingeben!
%h=[8.25e-6 7.875e-6 e-6 9.342e-6 7.627e-6 6.963e-6];
 h=8.25e-6;
...
% Eingabe der restlichen Größen
    ...
    %h0      = 20e-6;     % Spalthöhe am Spalteingang in m
    h_r     = h0;         % Funktion der Spalthöhe, abhängig von R
    r0      = 50e-6;      % Radius Speißebohrung in  m  
    ra      = 4.5e-3;     % Endradius des Lagerspalts
    pa      = 101500;     % Umgebungsdruck in Pa
