function [R,P,Q,I,I_err,M0,re0stern] = RKV45_RPQI(ps,p0,T0,Rgas,kappa,my0,h0,h_r,r0,ra,eps)    
...
%     n_I = dlmread('I_n_gefiltert2008');
%     m_I = dlmread('I_m_gefiltert2008');
...
% Schrittweite  
    Ra  = ra/r0;
    intervalle = 100000;      % Anzahl der Subintervalle
