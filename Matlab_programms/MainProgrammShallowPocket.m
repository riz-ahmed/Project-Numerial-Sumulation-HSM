...
% plot((R*r0) / ra, (P*p0)/ps,'Color','red')
grid on
ylabel('Pressure in Pa')
xlabel('r in m')

%% theoretical pressure Pt
% Rp = rp /r0;                    % radius at the recess
% roundR = round(R,3);
% in = find(roundR == Rp);
% pt = P(in(1)) * p0;
% disp(['theoritical pressure, Pt: ',num2str(pt)])
toc
